...
namespace Vadean_Flaviu_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Vadean_Flaviu_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Vadean_Flaviu_Lab8Context context,
